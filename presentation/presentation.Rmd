...
# Pobierz plik do lokalnego folderu
#local_path <- "C:/git/mp-2023-ds-project-StowarzyszenieOvi/data/Sleep_dataset.csv"
#download.file(url, destfile = local_path, mode = "wb")

# Wczytaj dane z lokalnej ścieżki
#Sleep_dataset <- read.csv(url)
3summary(Sleep_dataset)
